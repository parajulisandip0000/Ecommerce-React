    ...
    <div>
      ...
      <header className="bg-gray-800 text-white py-4 sticky top-0 shadow-md ">
        <div className="flex justify-between items-center container mx-auto px-4">
          {/* Logo */}
          <Link to="/" className="text-3xl font-bold">Online Shopping Mart</Link>
          ...
          <div className="flex space-x-4">
            ...
            <Link to="/cart" className="text-white hover:text-yellow-500 flex items-center">
      ...
      <nav className="bg-gray-700 text-white">
        <div className="container mx-auto py-2 flex space-x-6 px-4">
          {/* Links */}
          <button onClick={toggleSidebar} className="flex items-center hover:text-yellow-500 text-white">
            <FaBars className="mr-2" /> All {/* Hamburger Icon */}
          </button>
          <Link to="/deals" className="hover:text-yellow-500">Today's Deals</Link>
          <Link to="/customer-service" className="hover:text-yellow-500">Customer Service</Link>
          <Link to="/registry" className="hover:text-yellow-500">Registry</Link>
          <Link to="/gift-cards" className="hover:text-yellow-500">Gift Cards</Link>
        </div>
      </nav>
